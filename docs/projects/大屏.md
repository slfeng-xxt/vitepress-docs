...
项目demo预览: <https://slfeng-xxt.github.io/large-screen/>
:::
...
【**版本一**：开发环境正常版本，但是线上有问题。原因：`_instance`在线上版本中为 undefined】
...
// createAppContainer.bind(null, TransportationOverlay) 的目的：将TransportationOverlay组件作为参数传递给createAppContainer函数
export const cardTypeMap = {
  [OVERLAY_ENUM.transportation]: createAppContainer.bind(
    null,
    TransportationOverlay
...
- [css后处理器：autoprefixer](https://blog.csdn.net/qq_44919431/article/details/145797657)【**TODO**: 待添加】
...
**参考**：[前端工程化/pnpmmonorepo工程管理](/front/前端工程化/pnpmmonorepo工程管理#_5-代码风格和质量检查)
...
:::tip
当你看见河，你已在河之外；当你看见山，你已在山之外。当你能看到自己任何情绪，你已在情绪之外。真正的强大不是对抗，而是永许发生。你接纳什么，什么就会消失。你对抗什么，什么就会存在。
:::

## 5.Threejs 实现3D 地图 (TODO)

### 5.1 参考链接

- <https://blog.csdn.net/qq_57952018/article/details/143107629>
- <https://www.cnblogs.com/tiandi/p/18262383>
- <https://www.cnblogs.com/tiandi/p/18522344>
- <https://blog.csdn.net/weixin_40313413/article/details/140269239?utm_medium=distribute.pc_relevant.none-task-blog-2~default~baidujs_baidulandingword~default-1-140269239-blog-143107629.235^v43^pc_blog_bottom_relevance_base8&spm=1001.2101.3001.4242.2&utm_relevant_index=4>

### 5.2 山河鉴·3D 地图

- <https://shj.studio/website/index.html#xiazai>
- <https://shjv.yuque.com/org-wiki-shjv-psfwkn/shj/cdg9eh4gf8ik3g43>

### 5.3 一款让你的三维可视化项目快速落地的开源框架
